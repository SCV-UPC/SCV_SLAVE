...
class GoogleSTT(AbstractSTTEngine):
    ...
    def __init__(self, api_key='AIzaSyDgU56QeumsMHrJ6kP7xXOMCM8hFOKZp6U', language='en-us'):
...
class GoogleSTT2(AbstractSTTEngine):
    """
    Speech-To-Text implementation which relies on the Google Speech API.
    ...
    def __init__(self, api_key='AIzaSyDgU56QeumsMHrJ6kP7xXOMCM8hFOKZp6U', language='es-es'):
        # FIXME: get init args from config
        """
        Arguments:
        api_key - the public api key which allows access to Google APIs
...
class AttSTT(AbstractSTTEngine):
    ...
    def __init__(self, app_key='akgpcgksgua9ak6coo2gbsmcipbw4tza', app_secret='q7m0gegmnh6aidcycvkgalczhp1m6d5y',lang='en-Us'):
        self._logger = logging.getLogger(__name__)
        self._token = None
	self._language=None
    ...
    def _get_response(self, data):
        headers = {'authorization': 'Bearer %s' % self.token,
		   ...
		   'Content-Language': self._language}
...
class AttSTT2(AbstractSTTEngine):
    """
    Speech-To-Text implementation which relies on the AT&T Speech API.
    ...
    def __init__(self, app_key='akgpcgksgua9ak6coo2gbsmcipbw4tza', app_secret='q7m0gegmnh6aidcycvkgalczhp1m6d5y',lang='es-us'):
        self._logger = logging.getLogger(__name__)
        self._token = None
	self._language=None
        self.app_key = app_key
...
class WitAiSTT(AbstractSTTEngine):
    ...
    def __init__(self, access_token='62Z4YOLS4ULORUBITFVT7WO6DJULX2ZV'):
        self._logger = logging.getLogger(__name__)
    ...
    def transcribe(self, fp):
        data = fp.read()
        r = requests.post('https://api.wit.ai/speech?v=20150508',
                          data=data,
...
class WitAiSTT2(AbstractSTTEngine):
    """
    Speech-To-Text implementation which relies on the Wit.ai Speech API.
    ...
    def __init__(self, access_token='AHWDLGI7GWULZLVKKTTX5FOADV74THYV'):
        self._logger = logging.getLogger(__name__)
        self.token = access_token
